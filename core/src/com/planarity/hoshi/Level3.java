...
public class Level3 implements Screen {
    ...
    private Sprite circle11;
    private Sprite circle12;
    private Sprite circle13;
    private Sprite circle14;
    private Sprite circle15;
    ...
    private Rectangle circle11Rectangle;
    private Rectangle circle12Rectangle;
    private Rectangle circle13Rectangle;
    private Rectangle circle14Rectangle;
    private Rectangle circle15Rectangle;
    ...
    public void show() {
        ...
        circle11 = new Sprite(circleTexture);
        circle11.setPosition(Gdx.graphics.getWidth()/4 - circle.getWidth()/2, Gdx.graphics.getHeight()/4*3 - circle.getHeight()/2);
        circle12 = new Sprite(circleTexture);
        circle12.setPosition(Gdx.graphics.getWidth()/4*3 - circle.getWidth()/2, Gdx.graphics.getHeight()/4*3 - circle.getHeight()/2);
        circle13 = new Sprite(circleTexture);
        circle13.setPosition(150 - circle.getWidth()/4 - circle.getWidth()/2, Gdx.graphics.getHeight()/4 - circle.getHeight()/2);
        circle14 = new Sprite(circleTexture);
        circle14.setPosition(Gdx.graphics.getWidth()/4*3 - circle.getWidth()/2, Gdx.graphics.getHeight()/4 - circle.getHeight()/2);
        circle15 = new Sprite(circleTexture);
        circle15.setPosition(Gdx.graphics.getWidth()/4 - circle.getWidth()/2 - 100, Gdx.graphics.getHeight()/2 - circle.getHeight()/2);
        ...
        p11 = new Vector2(pos11X, pos11Y);
        p12 = new Vector2(pos12X, pos12Y);
        p13 = new Vector2(pos13X, pos13Y);
        p14 = new Vector2(pos14X, pos14Y);
        p15 = new Vector2(pos15X, pos15Y);
    ...
    public void render(float delta) {
        ...
        circle11Rectangle = new Rectangle(posX - 75, posY - 75, 150, 150);
        circle12Rectangle = new Rectangle(pos2X - 75, pos2Y - 75, 150, 150);
        circle13Rectangle = new Rectangle(pos3X - 75, pos3Y - 75, 150, 150);
        circle14Rectangle = new Rectangle(pos4X - 75, pos4Y - 75, 150, 150);
        circle15Rectangle = new Rectangle(pos5X - 75, pos5Y - 75, 150, 150);
        ...
        if(circleRectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active5 && !active6 && !active7 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle2Rectangle.contains(touchPos.x, touchPos.y) &&
                !active1 && !active3 && !active4 &&!active5 && !active6 && !active7 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle3Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active1 && !active4 && !active5 && !active6 && !active7 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle4Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active1 && !active5 && !active6 && !active7 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle5Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active1 && !active6 && !active7 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle6Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active5 && !active1 && !active7 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle7Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active5 && !active6 && !active1 && !active8 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle8Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active5 && !active6 && !active7 && !active1 && !active9 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle9Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active5 && !active6 && !active7 && !active8 && !active1 && !active10) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
        ...
        if(circle10Rectangle.contains(touchPos.x, touchPos.y) &&
                !active2 && !active3 && !active4 && !active5 && !active6 && !active7 && !active8 && !active9 && !active1) {
            if(Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {
